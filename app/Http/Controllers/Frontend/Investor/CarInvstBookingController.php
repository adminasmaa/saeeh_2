...
class CarInvstBookingController extends Controller
{
    ...
    { 
    if($type=='all'){
       $allbookings = Car::join('countries', 'countries.id', '=', 'cars.country_id')->join('car_bookings', 'cars.id', '=', 'car_bookings.car_id')->join('booking_status', 'booking_status.id', '=', 'car_bookings.booking_status_id')->select('*','car_bookings.id as book_id')
