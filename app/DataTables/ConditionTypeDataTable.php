...
class ConditionTypeDataTable extends DataTable
{
    private $crudName = 'conditioning_types';
     ...
     */
    public function query(ConditionType $model): QueryBuilder
    {
    ...
    {
        return ConditionType::all()->count();
    }
    ...
    {
        return $this->builder()
            ->setTableId('conditiontype-table')
    ...
    {
        return 'ConditionType_' . date('YmdHis');
    }
}
