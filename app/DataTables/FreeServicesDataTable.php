...
class FreeServicesDataTable extends DataTable
{
    private $crudName = 'free_services';
     ...
     *
     * @param \App\Models\FreeService $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FreeService $model): QueryBuilder
    {
    ...
    {
        return 'FreeServices_' . date('YmdHis');
    }
}
