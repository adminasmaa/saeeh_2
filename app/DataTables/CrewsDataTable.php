...
class CrewsDataTable extends DataTable
{
    private $crudName = 'crews';
     ...
     *
     * @param \App\Models\Crew $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Crew $model): QueryBuilder
    {
