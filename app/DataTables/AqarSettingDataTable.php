...
class AqarSettingDataTable extends DataTable
{
    private $crudName = 'aqar_setting';
     ...
     *
     * @param \App\Models\AqarSetting $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AqarSetting $model): QueryBuilder
    {
    ...
    {
        return 'aqar_setting_' . date('YmdHis');
    }
}
