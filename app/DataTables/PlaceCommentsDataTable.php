...
class PlaceCommentsDataTable extends DataTable
{
    private $crudName = 'place_comments';
     ...
     *
     * @param \App\Models\PlaceComment $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PlaceComment $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('placecomments-table')
    ...
    {
        return 'PlaceComments_' . date('YmdHis');
    }
}
