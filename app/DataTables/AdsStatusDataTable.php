...
class AdsStatusDataTable extends DataTable
{
    private $crudName = 'ads_status';
     ...
     *
     * @param \App\Models\AdsStatus $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AdsStatus $model): QueryBuilder
    {
