...
class PlaceTableDataTable extends DataTable
{
    private $crudName = 'place_tables';
     ...
     *
     * @param \App\Models\PlaceTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PlaceTable $model): QueryBuilder
    {
    ...
    {
        return 'PlaceTables_' . date('YmdHis');
    }
}
