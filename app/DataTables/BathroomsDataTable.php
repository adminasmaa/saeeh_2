...
class BathroomsDataTable extends DataTable
{
    private $crudName = 'bathrooms';
     ...
     */
    public function query(Bathroom $model): QueryBuilder
    {
