...
class CarPositionDataTable extends DataTable
{
    private $crudName = 'car_positions';
     ...
     *
     * @param \App\Models\CarPosition $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CarPosition $model): QueryBuilder
    {
    ...
    {
        return 'CarPositions_' . date('YmdHis');
    }
}
