...
class CarCommentsDataTable extends DataTable
{
    private $crudName = 'car_comments';
     ...
     *
     * @param \App\Models\CarComment $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CarComment $model): QueryBuilder
    {
    ...
    {
        return 'CarComments_' . date('YmdHis');
    }
}
