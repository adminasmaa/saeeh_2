...
class AqarServiceDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\AqarService $model
    ...
    {
        return AqarService::where('parent_id',null)->count();
    ...
    {
        return 'AqarService_' . date('YmdHis');
    }
}
