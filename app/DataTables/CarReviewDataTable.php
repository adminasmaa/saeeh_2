...
class CarReviewDataTable extends DataTable
{
    private $crudName = 'car_reviews';
     ...
     *
     * @param \App\Models\CarReview $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CarReview $model): QueryBuilder
    {
    ...
    {
        return 'CarReviews_' . date('YmdHis');
    }
}
