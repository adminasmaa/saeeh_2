...
class AqarCommentsDataTable extends DataTable
{
    private $crudName = 'aqar_comments';
     ...
     *
     * @param \App\Models\AqarComment $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AqarComment $model): QueryBuilder
    {
    ...
    {
        return 'AqarComments_' . date('YmdHis');
    }
}
