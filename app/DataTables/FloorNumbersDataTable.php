...
class FloorNumbersDataTable extends DataTable
{
    private $crudName = 'floor_numbers';
     ...
     *
     * @param \App\Models\FloorNumber $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FloorNumber $model): QueryBuilder
    {
    ...
    {
        return 'FloorNumbers_' . date('YmdHis');
    }
}
