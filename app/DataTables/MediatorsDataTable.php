...
class MediatorsDataTable extends DataTable
{
    private $crudName = 'mediators';
     ...
     *
     * @param \App\Models\Mediator $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Mediator $model): QueryBuilder
    {
