                                        ...
                                        @foreach($place->placeComments as $comment)
                                            <div class="condition-content">
                                                <div class="d-flex justify-content-between reviews-contentt">
                                                    ...
                                                    <div class="department-badge bg-main text-white">
                                                        <div class="pt-1">{{ round(\App\Models\PlaceReview::where('user_id', '=', $comment->user->id)->where('place_id', '=',$place->id)->avg('rate')) ?? 0 }}</div>
                                                        <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body " id="screen">
                    <div class="modal-content-video">
                        <video class="video-full" id="video-full" src="{{asset('images/places/videos/'.$place->videos)}}"    onerror="this.src='{{FRONTASSETS}}/images/restaurants/video-play-icon.png'" controls="" autoplay="" loop="">
