                    ...
                    @foreach(json_decode($place->images) as $image)
                      ...
                      <div class="resro-image">
                        ...
                        <img
                          ...
                          src="{{asset('images/places/'.$image)}}"  onerror="this.src='{{FRONTASSETS}}/images/restaurants/resto-card-1.png'"
                          class="of-cover"
                          alt="image 1"
                        />
                      </div>
                    ...
                    <div class="card-body position-relative">
                      ...
                      >
                        ...
                        <div class="department-badge bg-main text-white">
                          ...
                          <div class="number-ads gray-txt">{{$place->placeComments->count() ?? 0}} @lang('site.comments')</div>
                        </div>
                      </div>
