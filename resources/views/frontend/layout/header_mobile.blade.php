        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-7 col-5">
                <div class="header-logo">
                    <a class="" href="#">
                        <img src="./assets/images/logo.svg" alt="logo" class="img-logo-mobile" />
                    </a>
                </div>
            </div>
                            ...
                            <ul class="submenu list-unstyled">
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/car-icons/car-icon-2.png" alt="car-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>هواوي</div>
                                        </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/car-icons/car-icon-3.png" alt="car-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>نيسان</div>
                                        </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/car-icons/car-icon-4.png" alt="car-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>جيب</div>
                                        </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/car-icons/car-icon-5.png" alt="car-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>هايونداي</div>
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/car-icons/car-icon-6.png" alt="car-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>كيا</div>
                                        </div>
                                            ...
                                            <div class="pb-1 ps-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#FF8600" stroke-width="1.5" stroke-linecap="round" />
                                                </svg>
                                            </div>
                                            ...
                                            <div class="pb-1 ps-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#FF8600" stroke-width="1.2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        ...
                                                        stroke="#FF8600" stroke-width="1.71429" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                            ...
                                            <div class="pb-1 ps-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#FF8600" />
                                                    <path d="M5 18H13M19 18H17" stroke="#FF8600" stroke-width="1.5"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="pb-1 ps-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19"
                                                    ...
                                                    <path d="M6 7H14M5 11H6M14 11H15" stroke="#FF8600"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#FF8600" stroke-width="1.2" />
                                                </svg>
                                            </div>
                                            ...
                                            <div class="pb-1 ps-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        fill="#FF8600" />
                                                    <path d="M19 5.5H20L19.75 9H19.25L19 5.5Z" fill="#FF8600" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <ul class="submenu list-unstyled">
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/nav-icons/flag-ar.svg" alt="lang-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>العربية</div>
                                        </div>
                                ...
                                <li class="pb-2">
                                    <a href="#" class="sub-menu-link">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img src="./assets/images/nav-icons/flag-en.png" alt="lang-icon"
                                                    class="ps-2" />
                                            </div>
                                            <div>English</div>
                                        </div>
                ...
                <div class="col-10">
                    <ul class="list-unstyled">
                        <li class="btn-saeeh btn-space d-flex justify-content-center align-items-center">
                            <a href="#" class=" border-0 btn-frm-owner" data-bs-toggle="modal"
