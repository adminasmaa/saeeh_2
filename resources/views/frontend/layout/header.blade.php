...
<!-- Modal Help -->
<form class="help-modal">
    <div class="modal fade modal-custom modal-height-mobile" id="helpModal" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body help-body d-lg-flex justify-content-lg-between">
                        ...
                        <div class="row d-flex justify-content-center align-items-center h-100">
                            <div class="col-md-10 col-10 my-lg-5 my-2">
                                ...
                                <div class="emailcont">
                                    ...
                                    <input type="text" class="form-control frm-input mb-3 name1" id="name" name="name"
                                        placeholder=" {{trans('site.Enter the full name')}}" />

                                </div>
                                <div class="emailcont">
                                    <label for="frm-input2" class="pb-2"> @lang('site.phone')</label>
                                    <input type="text" class="form-control frm-input mb-3 phone" id="phone" name="phone"
                                ...
                                <button type="submit" class="mt-4 btn-login formregisters"> @lang('site.send')</button>
