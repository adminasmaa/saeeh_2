...
<!-- Modal Register -->
<div class="modal fade modal-custom modal-height-mobile" id="registerModal" tabindex="-1"
    aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close-modal d-flex justify-content-center align-items-center"
                    ...
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col-md-8 col-10 my-lg-5 my-2">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="emailcont">
                                        <input type="name" class="form-control frm-input mb-3"
                                ...
                                <div class="col-lg-6">
                                    <div class="emailcont">
                                        <input type="email" class="form-control frm-input mb-3"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="emailcont">
                                        <input id="password-field" type="password" class="form-control input-user mb-3"
                                ...
                                <div class="col-lg-6">
                                    <div class="emailcont">
                                        <input id="password-field-confirm" type="password"
                                            class="form-control input-user mb-3" name="password"
                            ...
                            <div class="emailcont">
                                <input type="tel" class="form-control frm-input mb-3" placeholder="رقم الهاتف" />
                                <span class="icon-placeholder">
...
<!-- Modal Login -->
<div class="modal fade modal-custom modal-height-mobile" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="close-modal d-flex justify-content-center align-items-center"
            ...
            <div class="modal-body login-body d-lg-flex justify-content-lg-between">
                <div class="text-center my-lg-5 my-3 login-content">
                    <div class="row d-flex justify-content-center align-items-center h-100">
                        <div class="col-md-8 col-10 my-lg-5 my-2">
                            ...
                            <div class="emailcont">
                                <input id="password-field" type="password" class="form-control input-user my-3"
                                    name="password" placeholder="كلمة المرور" />
                                <span class="icon-placeholder">
