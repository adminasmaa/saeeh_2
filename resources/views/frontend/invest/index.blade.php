          ...
          <div class="booking_investor_card">
            <div class="row">
              <div class="col-lg-4 col-sm-6 col-12">
               <a href="{{(Auth::user()->type=='invest' && (Auth::user()->account_type_id ==1||Auth::user()->account_type_id ==2||Auth::user()->account_type_id ==3||Auth::user()->account_type_id ==4))?route('invst.aqars.index'):route('invst.cars.index')}}">
              ...
              <div class="col-lg-4 col-sm-6 col-12">
                <a href="{{(Auth::user()->type=='invest' && (Auth::user()->account_type_id ==1||Auth::user()->account_type_id ==2||Auth::user()->account_type_id ==3||Auth::user()->account_type_id ==4))?route('invst.listbookings','all'):route('invst.listbookingscar','all')}}">
                <div class="booking_card mb-4 text-center pt-sm-5 pb-sm-3 py-4">
                    <img
              ...
              <div class="col-lg-4 col-sm-6 col-12">
                <a href="{{(Auth::user()->type=='invest' && (Auth::user()->account_type_id ==1||Auth::user()->account_type_id ==2||Auth::user()->account_type_id ==3||Auth::user()->account_type_id ==4))?route('invst.listcommisions',['aqar','unpaid']):route('invst.listcommisions',['car','unpaid'])}}">
                  <div class="booking_card mb-4 text-center pt-sm-5 pb-sm-3 py-4">
                    <img
