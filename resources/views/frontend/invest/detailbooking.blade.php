          ...
          <div class="col-12">
            <div class="d-flex justify-content-end nav-section">
              <nav class="navbar navbar-expand-lg">
                <button type="button" class="btn btn-main btn-print">
                  ...
                  <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="table-txt">10000 درهم مغربي</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <div class="table-txt">2000 درهم مغربي</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <div class="table-txt">5000 درهم مغربي</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table class="table table-bordered table-sm">
                    <thead>
                      <tr>
                        ...
                        <th>
                          <div class="d-flex align-items-center">
                            <div class="th-txt">محمد السيد</div>
                          </div>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="table-txt">دوبلكس</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="table-txt"> الشريفية </div>
                        </td>
                      </tr>
                      <tr>
                        <td>
