            ...
            <div class="container">
                ...
                ><svg
                    ...
                    />
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)"> {{$aqar->name ?? ''}} </a>
                        </li>
                        <li>
                <span
                ><svg
                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            <div class="department-badge bg-main text-white">
                                <div class="pt-1">{{$aqar->aqarReview->avg('rate')}}</div>
                                <div>
                        ...
                        <div class="details-box mb-4 mt-lg-0 mt-3">
                            <div class="pb-2 p-3 d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div
                                        class="h2 text-main mb-0 padding-details">  {{$aqar->fixed_price ?? 0}}   </div>
                                </div>
                  ...
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="52"
                      ...
                      <image id="image0_634_42242" width="456" height="456"
                        ...
                        >
                            <a href="{{route('bookingaquars',$aqar->id)}}"> @lang('site.book')</a>
                        </div> -->
                    </div>
                                ...
                                <div class="row">
                                  ...
                                  ><svg
                                      ...
                                      <path
                                          ...
                                          fill="#FF8600"
                                      /></svg></span>
                                                                    <span class="text-second"> ({{$aqar->aqarReview->avg('rate')}})</span>
                                                                </div>
                                                                <div class="text-second text-center">
                                                                    {{$aqar->aqarReview->avg('rate')}} @lang('site.reviews')
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row mt-5 pb-2">
                                    <div class="col-12">
                                        ...
                                        >
                                            ...
                                            <div class="see-all">
                                                <a href="{{route('allcommentAqar',$aqar->id)}}"
