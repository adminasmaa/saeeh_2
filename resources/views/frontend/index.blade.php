                ...
                <div class="col-12">
                    <div class="owl-carousel owl-theme restaurant-owl">
                        <div class="card-tour mb-3">
                            <img
                                class="card-img-top"
                                src="{{asset('frontend/assets/images/restaurants/restaurant-1.jpg')}}"
                                alt="Card image cap"
                            />
                            <div
                                class="card-tour-body d-flex justify-content-center align-items-center"
                            >
                                <h2 class="card-title">كافيهات</h2>
                            </div>
                        </div>
                        <div class="card-tour mb-3">
                            <img
                                class="card-img-top"
                                src="{{asset('frontend/assets/images/restaurants/restaurant-2.jpg')}}"
                                alt="Card image cap"
                            />
                            <div
                                class="card-tour-body d-flex justify-content-center align-items-center"
                            >
                                <h2 class="card-title">تسوق</h2>
                            </div>
                        </div>
                        <div class="card-tour mb-3">
                            <img
                                class="card-img-top"
                                src="{{asset('frontend/assets/images/restaurants/restaurant-3.jpg')}}"
                                alt="Card image cap"
                            />
                            <div
                                class="card-tour-body d-flex justify-content-center align-items-center"
                            >
                                <h2 class="card-title">مطاعم</h2>
                            </div>
                        </div>
                        <div class="card-tour mb-3">
                            <img
                                class="card-img-top"
                                src="{{asset('frontend/assets/images/restaurants/rentaurant-4.jpg')}}"
                                alt="Card image cap"
                            />
                            <div
                                class="card-tour-body d-flex justify-content-center align-items-center"
                            >
                                <h2 class="card-title">ترفيه</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="owl-carousel owl-theme review-owl">
                        <div class="card card-reviews">
                            <div class="card-block">
                                <div class="card-yazı">
                                    <p class="text-center">
                                        تجربه اكثر من رائعه ساعدني الموقع بشكل كبير لايجاد ما
                                        اريد كما انه سهل الاستخدام
                                    </p>
