    ...
    <section class="upper-header d-flex justify-content-between">
        <div class="container w-100">
            <div class="row justify-content-between align-items-center my-2">
                <div class="col-4">
                    <a href="#">
                        <img class="logo" src="{{asset('frontend/assets/images/logo.svg')}}"/>
                    </a>
                </div>
                ...
                <div class="col-4">
                    <div class="d-flex justify-content-end nav-section">
                        <nav class="navbar navbar-expand-lg">
                          ...
                          <span
                          ><img
                                  src="{{asset('frontend/assets/images/nav-icons/flag-ar.svg')}}"
                                  alt="lang"
                              /></span>
                                            اللغة
                                            <span class="pe-2">
                                                            ...
                                                            <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                                               class="sub-menu-link">
                                                                <div class="d-flex align-items-center">
                                                                    <div>
                                                                        <img
                                                                            src="{{asset('frontend/assets/images/nav-icons/flag-en.png')}}"
                                                                            alt="lang-icon"
                                                                            class="ps-2"
                                                                        />
                                                                    </div>
...
<header class="px-0 pt-2 header-mobile mobile-view">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <ul
                    class="d-flex justify-content-around align-items-center list-unstyled"
                >
                    <li
                        class="btn-saeeh btn-space d-flex justify-content-center align-items-center"
                    >
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img
                                                    src="{{asset('frontend/assets/images/car-icons/car-icon-1.png')}}"
                                                    alt="car-icon"
                                                    class="ps-2"
                                                />
                                            </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img
                                                    src="{{asset('frontend/assets/images/car-icons/car-icon-2.png')}}"
                                                    alt="car-icon"
                                                    class="ps-2"
                                                />
                                            </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img
                                                    src="{{asset('frontend/assets/images/car-icons/car-icon-3.png')}}"
                                                    alt="car-icon"
                                                    class="ps-2"
                                                />
                                            </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img
                                                    src="{{asset('frontend/assets/images/car-icons/car-icon-4.png')}}"
                                                    alt="car-icon"
                                                    class="ps-2"
                                                />
                                            </div>
                                ...
                                <li class="pb-2">
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img
                                                    src="{{asset('frontend/assets/images/car-icons/car-icon-5.png')}}"
                                                    alt="car-icon"
                                                    class="ps-2"
                                                />
                                            </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <img
                                                    src="{{asset('frontend/assets/images/car-icons/car-icon-6.png')}}"
                                                    alt="car-icon"
                                                    class="ps-2"
                                                />
                                            </div>
    ...
    <section class="position-relative">
        <div class="hero-section hero-section-v2">
            <div class="hero-section-image">
                <img src="{{asset('frontend/assets/images/slider-image.png')}}" alt="slider image"/>
            </div>
            <div
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="banner-image mt-lg-0 mt-3">
                        <img src="{{asset('frontend/assets/images/banner-1.png')}}" alt="banner 1"/>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="banner-image mt-lg-0 mt-3">
                        <img src="{{asset('frontend/assets/images/banner-2.png')}}" alt="banner 2"/>
                ...
                <div class="col-12">
                    ...
                    >
                        ...
                        <div class="see-all">
                            <a href="#" class="h2">
                    <span
                    ><img src="{{asset('frontend/assets/images/arrow-circle.svg')}}" alt=""
                        /></span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="card-tour mb-3">
                            <img
                                ...
                                onerror="this.src='{{asset('frontend/assets/images/tours/tour-1.jpg')}}'"
                                alt="Card image cap"
                            />
                            <div
                            ...
                            >
                                ...
                                <div>
                                    <img
                                        ...
                                        onerror="this.src='{{asset('frontend/assets/images/turkey.png')}}'"
            ...
            <div class="row padding-row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="about-card mb-3 text-center">
                        <img src="{{asset('frontend/assets/images/trust-icon.svg')}}" alt="image"/>
                        <div class="pt-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="about-card mb-3 text-center">
                        <img
                            src="{{asset('frontend/assets/images/customer-service-icon.svg')}}"
                            alt="image"
                        />
                        <div class="pt-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="about-card mb-3 text-center">
                        <img src="{{asset('frontend/assets/images/rate-icon.svg')}}" alt="image"/>
                        <div class="pt-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="about-card mb-3 text-center">
                        <img src="{{asset('frontend/assets/images/search-icon.svg')}}" alt="image"/>
                        <div class="pt-3">
                            ...
                            <div class="hotel-item mb-3 round-border position-relative">
                                <div class="hotel-img">
                                    <img
                                        ...
                                        onerror="this.src='{{asset('frontend/assets/images/hotels/alrebat.jpg')}}'"
        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-3 col-md-6 center-in-mobile">
                    <div>
                        <img src="{{asset('frontend/assets/images/logo-white.svg')}}" alt=""/>
                            ...
                            <ul class="mt-3 d-flex list-unstyled list-icons">
                                <li class="footer-google-app">
                                    <a href="#" target="_blank" title="store">
                                        <img src="{{asset('frontend/assets/images/store.png')}}" alt="store"/>
                                    </a>
                                </li>
                                <li class="footer-google-app">
                                    <a href="#" target="_blank" title="google app">
                                        <img
                                            src="{{asset('frontend/assets/images/google-app.svg')}}"
                                            alt="google app"
                                        />
                                    </a>
                                </li>
                        ...
                        <ul class="mt-3 d-flex list-unstyled list-icons">
                            ...
                            >
                                <a href="#" class="lh-0" target="_blank" title="Snapchat">
                                    <img
                                        src="{{asset('frontend/assets/images/snapchat-icon.svg')}}"
                                        alt="Snapchat"
                                    />
                                </a>
                            </li>
                            ...
                            >
                                <a href="#" class="lh-0" target="_blank" title="Facebook">
                                    <img
                                        src="{{asset('frontend/assets/images/facebook-icon.svg')}}"
                                        alt="Facebook"
                                    />
                                </a>
                            </li>
                            ...
                            >
                                <a href="#" class="lh-0" target="_blank" title="Instagram">
                                    <img
                                        src="{{asset('frontend/assets/images/instagram-icon.svg')}}"
                                        alt="Instagram"
                                    />
                                </a>
                            </li>
                                    ...
                                    <li class="pt-2">
                                        <a href="#" class="link-time">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <img
                                                    src="{{asset('frontend/assets/images/outline-whatsapp.svg')}}"
                                                    alt="whatsapp"
                                                    class="pe-2"
                                                />
                                            </div>
