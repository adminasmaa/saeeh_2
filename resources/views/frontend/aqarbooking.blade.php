                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center mt-3">
                                <div class="department-badge bg-main text-white">
                                    <div class="pt-1">{{ isset($aqar->aqarReview) ? $aqar->aqarReview->avg('rate') : 0 }}</div>
                                    <div>
                                ...
                                <div class="number-ads gray-txt"> {{ isset($aqar->aqarComment) ? $aqar->aqarComment->count() : 0 }} @lang('site.comments') </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="wizard-tabs d-flex justify-content-center py-3">
                                ...
                                <span>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M12 6C12 6 10.5 4 7 4C3.5 4 2 6 2 6V20C2 20 3.5 19 7 19C10.5 19 12 20 12 20M12 6V20M12 6C12 6 13.5 4 17 4C20.5 4 22 6 22 6V20C22 20 20.5 19 17 19C13.5 19 12 20 12 20" stroke="#005D9F" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </span>
                              ...
                              <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                  <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="#005D9F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                  <path d="M8 12L11 15L16 10" stroke="#005D9F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                  </svg>
                              </span>
                                                        <span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="position-relative">
                                                        <input placeholder=" {{trans('site.reciept_date')}}" type="text"        name="reciept_date" id="datepicker" value="" class="calendar mb-4">
                                                        <span class="date-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path d="M15 1.49648L10.9965 1.4965V0.5C10.9965 0.22375 10.7727 0 10.4965 0C10.2203 0 9.9965 0.22375 9.9965 0.5V1.49625H5.9965V0.5C5.9965 0.22375 5.77275 0 5.4965 0C5.22025 0 4.9965 0.22375 4.9965 0.5V1.49625H1C0.44775 1.49625 0 1.944 0 2.49625V14.9963C0 15.5485 0.44775 15.9963 1 15.9963H15C15.5522 15.9963 16 15.5485 16 14.9963V2.49625C16 1.94423 15.5522 1.49648 15 1.49648ZM15 14.9963H1V2.49625H4.9965V3C4.9965 3.27623 5.22025 3.5 5.4965 3.5C5.77275 3.5 5.9965 3.27623 5.9965 3V2.4965H9.9965V3.00025C9.9965 3.2765 10.2203 3.50025 10.4965 3.50025C10.7727 3.50025 10.9965 3.2765 10.9965 3.00025V2.4965H15V14.9963ZM11.5 7.99649H12.5C12.776 7.99649 13 7.77249 13 7.49649V6.49649C13 6.22049 12.776 5.99648 12.5 5.99648H11.5C11.224 5.99648 11 6.22049 11 6.49649V7.49649C11 7.77249 11.224 7.99649 11.5 7.99649ZM11.5 11.9962H12.5C12.776 11.9962 13 11.7725 13 11.4962V10.4962C13 10.2202 12.776 9.99624 12.5 9.99624H11.5C11.224 9.99624 11 10.2202 11 10.4962V11.4962C11 11.7727 11.224 11.9962 11.5 11.9962ZM8.5 9.99624H7.5C7.224 9.99624 7 10.2202 7 10.4962V11.4962C7 11.7725 7.224 11.9962 7.5 11.9962H8.5C8.776 11.9962 9 11.7725 9 11.4962V10.4962C9 10.2205 8.776 9.99624 8.5 9.99624ZM8.5 5.99648H7.5C7.224 5.99648 7 6.22049 7 6.49649V7.49649C7 7.77249 7.224 7.99649 7.5 7.99649H8.5C8.776 7.99649 9 7.77249 9 7.49649V6.49649C9 6.22023 8.776 5.99648 8.5 5.99648ZM4.5 5.99648H3.5C3.224 5.99648 3 6.22049 3 6.49649V7.49649C3 7.77249 3.224 7.99649 3.5 7.99649H4.5C4.776 7.99649 5 7.77249 5 7.49649V6.49649C5 6.22023 4.776 5.99648 4.5 5.99648ZM4.5 9.99624H3.5C3.224 9.99624 3 10.2202 3 10.4962V11.4962C3 11.7725 3.224 11.9962 3.5 11.9962H4.5C4.776 11.9962 5 11.7725 5 11.4962V10.4962C5 10.2205 4.776 9.99624 4.5 9.99624Z" fill="#9C9C9C"/>
                                  </svg>
                              </span>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="position-relative">
                                                        <input placeholder="{{trans('site.delivery_date')}}" type="text" name="delivery_date" id="datepicker1" value="" class="calendar mb-4">
                                                        <span class="date-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                  <path d="M15 1.49648L10.9965 1.4965V0.5C10.9965 0.22375 10.7727 0 10.4965 0C10.2203 0 9.9965 0.22375 9.9965 0.5V1.49625H5.9965V0.5C5.9965 0.22375 5.77275 0 5.4965 0C5.22025 0 4.9965 0.22375 4.9965 0.5V1.49625H1C0.44775 1.49625 0 1.944 0 2.49625V14.9963C0 15.5485 0.44775 15.9963 1 15.9963H15C15.5522 15.9963 16 15.5485 16 14.9963V2.49625C16 1.94423 15.5522 1.49648 15 1.49648ZM15 14.9963H1V2.49625H4.9965V3C4.9965 3.27623 5.22025 3.5 5.4965 3.5C5.77275 3.5 5.9965 3.27623 5.9965 3V2.4965H9.9965V3.00025C9.9965 3.2765 10.2203 3.50025 10.4965 3.50025C10.7727 3.50025 10.9965 3.2765 10.9965 3.00025V2.4965H15V14.9963ZM11.5 7.99649H12.5C12.776 7.99649 13 7.77249 13 7.49649V6.49649C13 6.22049 12.776 5.99648 12.5 5.99648H11.5C11.224 5.99648 11 6.22049 11 6.49649V7.49649C11 7.77249 11.224 7.99649 11.5 7.99649ZM11.5 11.9962H12.5C12.776 11.9962 13 11.7725 13 11.4962V10.4962C13 10.2202 12.776 9.99624 12.5 9.99624H11.5C11.224 9.99624 11 10.2202 11 10.4962V11.4962C11 11.7727 11.224 11.9962 11.5 11.9962ZM8.5 9.99624H7.5C7.224 9.99624 7 10.2202 7 10.4962V11.4962C7 11.7725 7.224 11.9962 7.5 11.9962H8.5C8.776 11.9962 9 11.7725 9 11.4962V10.4962C9 10.2205 8.776 9.99624 8.5 9.99624ZM8.5 5.99648H7.5C7.224 5.99648 7 6.22049 7 6.49649V7.49649C7 7.77249 7.224 7.99649 7.5 7.99649H8.5C8.776 7.99649 9 7.77249 9 7.49649V6.49649C9 6.22023 8.776 5.99648 8.5 5.99648ZM4.5 5.99648H3.5C3.224 5.99648 3 6.22049 3 6.49649V7.49649C3 7.77249 3.224 7.99649 3.5 7.99649H4.5C4.776 7.99649 5 7.77249 5 7.49649V6.49649C5 6.22023 4.776 5.99648 4.5 5.99648ZM4.5 9.99624H3.5C3.224 9.99624 3 10.2202 3 10.4962V11.4962C3 11.7725 3.224 11.9962 3.5 11.9962H4.5C4.776 11.9962 5 11.7725 5 11.4962V10.4962C5 10.2205 4.776 9.99624 4.5 9.99624Z" fill="#9C9C9C"/>
                                  </svg>
                              ...
                              />
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <textarea class="form-control txtarea-booking px-3 py-2 mt-2" placeholder="{{trans('site.If you have an inquiry')}}" rows="4" name="note"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
