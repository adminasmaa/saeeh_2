                                    ...
                                    <li class="pb-2">
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/car-icons/car-icon-1.png"
                                                        alt="car-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li class="pb-2">
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/car-icons/car-icon-2.png"
                                                        alt="car-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li class="pb-2">
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/car-icons/car-icon-3.png"
                                                        alt="car-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li class="pb-2">
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/car-icons/car-icon-4.png"
                                                        alt="car-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li class="pb-2">
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/car-icons/car-icon-5.png"
                                                        alt="car-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/car-icons/car-icon-6.png"
                                                        alt="car-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li class="pb-2">
                                        <a href="#">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/nav-icons/flag-ar.svg"
                                                        alt="lang-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
                                    ...
                                    <li class="pb-2">
                                        <a href="#" class="sub-menu-link">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <img
                                                        src="./assets/images/nav-icons/flag-en.png"
                                                        alt="lang-icon"
                                                        class="ps-2"
                                                    />
                                                </div>
...
<a class="favouritess" id="favouritess{{$aquar->id}}" data-id="{{$aquar->id}}"><i class=" @if($aquar->favoriteuser->count()>0) fas @else far @endif far fa-heart "></i></a>
