                            ...
                            <li id="tab-1">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @foreach($aqarbooking->unique('car_id') as $booking)
                                                            ...
                                                            <div class="col-auto">
                                                                ...
                                                                >
                                                                    <div class="department-badge bg-main text-white">
                                                                        <div class="pt-1">{{ round($booking->aqar->aqarReview->avg('rate')) ?? 0 }}</div>
                                                                        <div>
                            ...
                            <li id="tab-2">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        @foreach($carBooking->unique('car_id') as $book)
                                            @if(!empty($book->car))
                                        <div
                                            class="card card-department round-border mb-4 p-md-3 p-2"
                                        >
                                ...
                                >
                                                            ...
                                                            <div class="col-auto">
                                                                ...
                                                                >
                                                                    <div class="department-badge bg-main text-white">
                                                                        <div class="pt-1">{{ round($book->car->CarReview->avg('rate')) ?? 0}}</div>
                                                                        <div>
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                                                                <path d="M12.7529 19.6185L20.1689 24.3301L18.2009 15.4501L24.7529 9.47534L16.1249 8.70481L12.7529 0.330078L9.38093 8.70481L0.75293 9.47534L7.30493 15.4501L5.33693 24.3301L12.7529 19.6185Z" fill="white"/>
                                                                            </svg>
