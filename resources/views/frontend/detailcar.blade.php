    ...
    <main>
        ...
        <section class="py-4">
            <div class="container">
                    ...
                    <div class="col-lg-10">
                        <div id="slides">
                            <div class="slide show" data-slide="1">
                                <img src="{{FRONTASSETS}}/images/cars/car.png" alt="car"/>
                            </div>
                    ...
                    >
                      ...
                      <defs>
                        ...
                        />
                                    ...
                                    >يتم دفع العربون فى حالة الحجز</span
                                    >
                                </div>
                            </div>
                            <div
                                        ...
                                        <div class="accordion" id="accordion_details">
                                                ...
                                                >
                                                    <div class="accordion-body">
                                                        <div class="custom-ul-list">
                                                            <div class="custom-ul-list-item">{{$car->category ??''}}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion-item details-item mb-2">
                                                ...
                                                >
                                                    <div class="accordion-body">
                                                        <div class="custom-ul-list">
                                                            <div class="custom-ul-list-item">5</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item details-item mb-2">
                                                <h2 class="accordion-header">
                                                    ...
                                                    >
                                                        <div>
                                                            ...
                                                            >
                                                                <path
                                                                    d="M23.3333 4H18.6667V2.66667C18.6656 1.95975 18.3843 1.28208 17.8844 0.782217C17.3846 0.282349 16.7069 0.001058 16 0H10.6667C9.95975 0.001058 9.28209 0.282349 8.78222 0.782217C8.28235 1.28208 8.00106 1.95975 8 2.66667V4H3.33333C2.44949 4.00071 1.60206 4.35212 0.977091 4.97709C0.352123 5.60206 0.000706223 6.4495 0 7.33333V20.6667C0.000706223 21.5505 0.352123 22.3979 0.977091 23.0229C1.60206 23.6479 2.44949 23.9993 3.33333 24H23.3333C24.2172 23.9993 25.0646 23.6479 25.6896 23.0229C26.3145 22.3979 26.666 21.5505 26.6667 20.6667V7.33333C26.666 6.4495 26.3145 5.60206 25.6896 4.97709C25.0646 4.35212 24.2172 4.00071 23.3333 4ZM9.33333 2.66667C9.33333 2.31304 9.47381 1.97391 9.72386 1.72386C9.97391 1.47381 10.313 1.33333 10.6667 1.33333H16C16.3536 1.33333 16.6928 1.47381 16.9428 1.72386C17.1929 1.97391 17.3333 2.31304 17.3333 2.66667V4H9.33333V2.66667ZM25.3333 20.6667C25.3333 21.1971 25.1226 21.7058 24.7475 22.0809C24.3725 22.456 23.8638 22.6667 23.3333 22.6667H3.33333C2.8029 22.6667 2.29419 22.456 1.91912 22.0809C1.54405 21.7058 1.33333 21.1971 1.33333 20.6667V12.036L9.12267 14.6333C9.1907 14.6555 9.26179 14.6667 9.33333 14.6667H17.3333C17.4049 14.6667 17.476 14.6555 17.544 14.6333L25.3333 12.036V20.6667ZM25.3333 10.6747C25.2621 10.672 25.191 10.681 25.1227 10.7013L17.2253 13.3333H9.44133L1.544 10.7C1.4757 10.6797 1.40454 10.6707 1.33333 10.6733V7.33333C1.33333 6.8029 1.54405 6.29419 1.91912 5.91912C2.29419 5.54405 2.8029 5.33333 3.33333 5.33333H23.3333C23.8638 5.33333 24.3725 5.54405 24.7475 5.91912C25.1226 6.29419 25.3333 6.8029 25.3333 7.33333V10.6747Z"
                                                                    fill="#9C9C9C"
                                                                />
                                                            </svg>
                                                            شنطه كبيرة
                                                ...
                                                >
                                                    <div class="accordion-body">
                                                        <div class="custom-ul-list">
                                                            <div class="custom-ul-list-item">1</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item details-item mb-2">
                                                ...
                                                >
                                                    <div class="accordion-body">
                                                        <div class="custom-ul-list">
                                                            <div class="custom-ul-list-item">{{$car->car_numbers ?? 0}}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="col-lg-6 pb-4">
                                        <div
                                            class="d-flex justify-content-between align-items-center"
                                        >
                                            <div class="text-gray-2 pb-1">النظافة</div>
                                            <div class="">5</div>
                                        </div>
                                        <div class="loading-range">
                                            <div class="base-range">
                                    ...
                                    <div class="col-lg-6 pb-4">
                                        <div
                                            class="d-flex justify-content-between align-items-center"
                                        >
                                            <div class="text-gray-2 pb-1">@lang('site,price')</div>
                                            <div class="">5</div>
                                        </div>
                                        <div class="loading-range">
                                            <div class="base-range">
                                        ...
                                        <div class="condition-content">
                                            ...
                                            >
                                                <div class="d-sm-flex w-100">
                                                    <div class="reviews-image">
                                                        <img
                                                            src="{{FRONTASSETS}}/images/review-image-2.png"
                                                            alt=""
                                                        />
                                                    </div>
                                                    <div class="w-100 padding-right">
                                                        <h2 class="reviews-title d-flex text-second">
                                                            ...
                                                            <div>
                                                                <img
                                                                    src="{{FRONTASSETS}}/images/car-icons/morocco.png"
                                                                    alt="flag-icon"
                                                                />
                                                            </div>
                                                        </h2>
                                                ...
                                                <div class="department-badge bg-orange text-white">
                                                    <div class="pt-1">4</div>
                                                    <div>
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            width="25"
                                            ...
                                            <div class="col-lg-3 my-5">
                                                ...
                                                >
                                                    <a
                                                        href="#"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#AllRatingsModal"
                                                    >اقرأ جميع التقييمات
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 pt-4">
                                        <div class="condition-content">
                                            ...
                                            <p class="details-sm-txt padding-right">
                                                برجاء اتباع سياسه المكان
                                            </p>
                                            <hr class="hr-saeeh" />
                                        </div>
                                        <div class="condition-content">
                                            <h2 class="condition-title">مواعيد الموصول</h2>
                                            <p class="details-sm-txt padding-right">
                                                برجاء اتباع سياسه المكان
                                            </p>
                                            <hr class="hr-saeeh" />
                ...
                <div class="row">
                    <div class="tabs-detaills mt-3">
                        <ul class="tabs-nav-detaills list-unstyled d-flex mb-0">
                            <li class="py-1 px-2">
                                <a
                                    href="#tab-detail-1"
                                    class="tab-link d-flex align-items-center justify-content-center"
                                ...
                                >سيارة ماركة فولكس رمادي غامق ويغن فئه GIS
                                  ...
                                  >
                                                            ...
                                                            <div class="col-auto">
                                                                ...
                                                                >
                                                                    <div
                                                                        class="department-badge bg-main text-white ms-2"
                                                                    >
                                                                        <div class="pt-1">5</div>
                                                                        <div class="mb-1">
                                                                            <svg
                                                                            ...
                                                                            >
                                                                                <path
                                                                                    d="M12.7529 19.5462L20.1689 24.2578L18.2009 15.3778L24.7529 9.40308L16.1249 8.63255L12.7529 0.257812L9.38093 8.63255L0.75293 9.40308L7.30493 15.3778L5.33693 24.2578L12.7529 19.5462Z"
                                                                                    fill="white"
                                                                                />
                                                                            </svg>
                                                                        </div>
