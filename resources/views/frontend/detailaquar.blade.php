                            ...
                            @if(!empty($aquar->images))
                                @foreach(explode(',',$aquar->images) as $key=>$img)
                                    <div class="thumbnail" data-slide="{{$key}}">
                                        <img src="{{asset('images/aqars/'.$img)}}"
                                             onerror="this.src='{{FRONTASSETS}}/images/department-1.svg'" alt="department"/>
                                    </div>
                                @endforeach
                                                    ...
                                                    <h2 class="accordion-header">
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                <img src="{{asset('images/services_aqars/'.$section->icon)}}"
                                                                     width="50" height="50"
                ...
                >
                      ...
                      <span>
                        ...
                        >
                          ...
                          />
                                                        ...
                                                        <span class="text-gray-2 h2 mb-0 badge-txt">{{$value->reviewElement->name ?? ''}} </span>
                                                    </div>
                                                    <!-- Output HTML -->

                                                    <div class="rate">
                                                        <input type="hidden" name="aqar_id" value="{{$aquar->id}}" class="aqar_id">
                                                        <input type="hidden" name="review_element_id " value="{{$value->reviewElement->id}}" class="review_element_id ">
                                                        <input type="radio" id="star555{{$key}}" name="rate" value="5" class="rate" />
                                                        <label for="star555{{$key}}" title="text">5 stars</label>
                                                        <input type="radio" id="star444{{$key}}" name="rate" value="4"  class="rate"/>
                                                        <label for="star444{{$key}}" title="text">4 stars</label>
                                                        <input type="radio" id="star333{{$key}}" name="rate" value="3"  class="rate"/>
                                                        <label for="star333{{$key}}" title="text">3 stars</label>
                                                        <input type="radio" id="star222{{$key}}" name="rate" value="2" class="rate" />
                                                        <label for="star222{{$key}}" title="text">2 stars</label>
                                                        <input type="radio" id="star111{{$key}}" name="rate" value="1"  class="rate"/>
                  ...
                  ></textarea>
                                        ...
                                        <div class="col-12 d-flex justify-content-md-end pt-lg-5 pt-3">
                                            ...
                                            >
                                                <button  type="submit" class="formregistersRateAqar">@lang('site.add')</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
