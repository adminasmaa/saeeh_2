                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('site.deposits')</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="email-app-sidebar  task-sidebar">
                                            ...
                                            <ul class="nav main-menu" role="tablist">
                                                ...
                                                <li ><a 
                                                       href="{{route('dashboard.deposits',['aqar','unpaid'])}}"  class="{{$current_route=='aqar'?'activee': ''}}"
                                                      ><span
                                                            class=" title btn btn-light" style="font-size:20px;" > @lang('site.aqars')</span></a></li>

                                                <li ><a
                                                        href="{{route('dashboard.deposits',['car','unpaid'])}}" class="{{$current_route=='car'?'activee': ''}}"
                                                ><span
