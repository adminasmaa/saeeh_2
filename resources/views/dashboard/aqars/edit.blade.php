...
=======
                                            <!-- <div class="row">
>>>>>>> 3607a7f9eaa39a9aea5834e697fa3a4f4b8b34ea
                                                <div class="col-md-6 form-group col-12 p-2">
                                                    <span class="text-danger">*</span>
                                                            <label>@lang('site.display_photo')</label>
                                                            <input type="file" name="main_image" class="form-control"
                                        ...
                                        @endforeach
                                           ...
                                           <div style="display: none;" id="bathroomnumber">
                                            ...
                                            <div class="col m-t-15">
                                                @for ($x = 1; $x <= 10; $x++)
                                                <div class="form-check form-check-inline checkbox checkbox-solid-primary">
                                                    <input class="form-check-input" id="masterroom_{{$x}}" type="checkbox" name="masterroom"  value="{{$x}}" {{ $x==$aqar->masterroom? 'checked':'' }}>
                                            ...
                                            <div class="col m-t-15">
                                                ...
                                                <div class="form-check form-check-inline checkbox checkbox-solid-primary">
                                                    <input class="form-check-input" id="position_{{$position->id}}" type="checkbox" name="car_position_id[]" value="{{$position->id}}"  {{ in_array($position->id,$aqar->car_position_id)? 'checked':'' }}>
                                            ...
                                            <div class="col m-t-15">
                                                @foreach($Pool as $swp)
                                                <div class="form-check form-check-inline checkbox checkbox-solid-primary">
                                                    <input class="form-check-input" id="swimmingpool_{{$swp->id}}" type="checkbox" name="swimmingpool[]" value="{{$swp->id}}"  {{ in_array($swp->id,$aqar->swimmingpool)? 'checked':'' }}>
