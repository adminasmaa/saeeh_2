                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col m-t-15">
                                                @for ($x = 1; $x <= 10; $x++)
                                                <div class="form-check form-check-inline checkbox checkbox-solid-primary">
                                                    <input class="form-check-input" id="masterroom_{{$x}}" type="checkbox" name="masterroom[]" readonly="" value="{{$x}}" {{ in_array($x,$aqar->masterroom)? 'checked':'' }}>
                                            ...
                                            <div class="col m-t-15">
                                                @for ($y = 1; $y <= 10; $y++)
                                                <div class="form-check form-check-inline checkbox checkbox-solid-primary">
                                                    <input class="form-check-input" id="normalroom_{{$y}}" type="checkbox" name="normalroom[]" readonly="" value="{{$y}}" {{ in_array($y,$aqar->normalroom)? 'checked':'' }}>
