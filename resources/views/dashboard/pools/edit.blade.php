    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h3>@lang('site.pools')</h3>
                    </div>
                    <div class="col-6">
                        <ol class="breadcrumb">

                            <li class="breadcrumb-item">@lang('site.dashboard')</li>
                            <li class="breadcrumb-item active">@lang('site.pools') @endlang</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row second-chart-list third-news-update">
                <div class="col-xl-12 col-lg-11 xl-50 morning-sec box-col-12">
                    <form action="{{ route('dashboard.pools.update', $data->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group col-12 p-2">
                                    ...
                                    <select class="form-control btn-square" name="active">
                                        ...
                                        <option value="0"
                                                @if($data->active==0) selected @endif>@lang('site.inactive')
                                        </option>
