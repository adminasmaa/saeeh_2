                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('site.place_categories') @endlang</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="bg-secondary-lighten card-header d-flex justify-content-between">
                            ...
                            <div class="text-end  group-btn-top">
                                <div class="form-group d-flex form-group justify-content-between">
                                    ...
                                    <a href="{{route('dashboard.place_categories.create')}}" class="btn btn-air-primary btn-pill btn-primary"><i
